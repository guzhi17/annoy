...
func TestNodeBuild(t *testing.T) {
	for i, c := range []struct {
	...
	}{
		{
			vec: []float64{0.0, 1.0},
			items: []*item{
				{id: 0, vector: PointN{0.0, 1.0}},
				{id: 1, vector: PointN{0.0, -1.0}},
			},
			k:       2,
			dim:     2,
			expLeaf: true,
		},
		{
			...
			items: []*item{
				{id: 0, vector: PointN{0.0, 1.0}},
				{id: 0, vector: PointN{0.0, 1.1}},
				{id: 0, vector: PointN{0.0, 1.2}},
				{id: 1, vector: PointN{0.0, -1.0}},
				{id: 2, vector: PointN{0.0, -1.1}},
				{id: 2, vector: PointN{0.0, -1.2}},
			},
			k:       2,
			dim:     2,
			expLeaf: false,
